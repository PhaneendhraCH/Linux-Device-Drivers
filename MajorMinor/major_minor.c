...
#include	<linux/module.h> 	// module load,author
...
#include	<linux/types.h>	// prints error numbers
//#include	<linux/interrupt.h>
//#include	<linux/delay.h>
//#include    <linux/errno.h>
//#include    <linux/sched.h>		// struct tast_struct
...
#define WR_VALUE _IOW(MAGIC_NUMBER,'a',int32_t*) // copy from user
#define RD_VALUE _IOR(MAGIC_NUMBER,'b',int32_t*) // copy to user
...
static struct class *dev_class; 	// Creating a device dynamically
...
static int __init my_driver_init(void)
{
	...
	if((device_create(dev_class,NULL,dev,1,"my_Char_driver0"))==NULL) {
